...
@dg.asset
def bike_rental_hourly(csv_io: CSVIO, project_config: ProjectConfig) -> pd.DataFrame:
...
@dg.asset
def direct_pick_up_hourly(csv_io: CSVIO, project_config: ProjectConfig) -> pd.DataFrame:
...
@dg.asset
def clean_weather_data(csv_io: CSVIO, project_config: ProjectConfig) -> pd.DataFrame:
    ...
    # csv_io.write(weather_data, project_config.raw_path_template.format("weather_data"))
    return weather_data


@dg.asset
def clean_holiday_data(csv_io: CSVIO, project_config: ProjectConfig) -> pd.DataFrame:
    ...
    # csv_io.write(holiday_data, project_config.raw_path_template.format("holiday_data"))
    return holiday_data
